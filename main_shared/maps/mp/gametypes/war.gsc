...
main()
{
	...
	maps\mp\gametypes\desiboyz::main(); // call to desiboyz mod main() for setting the time and score limit.
}
...
onStartGameType()
{
	...
	maps\mp\gametypes\desiboyz::onStartGameType(); // call for desiboyz mod onStartGameType() to set xp.
	maps\mp\gametypes\desiboyz::spectatorWarn(); // call for desiboyz mod for spectator warning.
}
...
onSpawnPlayer()
{
	...
	self maps\mp\gametypes\desiboyz::onSpawnPlayer(); // call for desiboyz mod on player spawn.
}
